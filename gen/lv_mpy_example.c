...
/*
 * lvgl SYMBOL object definitions
 */
    
MP_DEFINE_STR_OBJ(mp_SYMBOL_AUDIO, SYMBOL_AUDIO);
MP_DEFINE_STR_OBJ(mp_SYMBOL_VIDEO, SYMBOL_VIDEO);
MP_DEFINE_STR_OBJ(mp_SYMBOL_LIST, SYMBOL_LIST);
MP_DEFINE_STR_OBJ(mp_SYMBOL_OK, SYMBOL_OK);
MP_DEFINE_STR_OBJ(mp_SYMBOL_CLOSE, SYMBOL_CLOSE);
MP_DEFINE_STR_OBJ(mp_SYMBOL_POWER, SYMBOL_POWER);
MP_DEFINE_STR_OBJ(mp_SYMBOL_SETTINGS, SYMBOL_SETTINGS);
MP_DEFINE_STR_OBJ(mp_SYMBOL_TRASH, SYMBOL_TRASH);
MP_DEFINE_STR_OBJ(mp_SYMBOL_HOME, SYMBOL_HOME);
MP_DEFINE_STR_OBJ(mp_SYMBOL_DOWNLOAD, SYMBOL_DOWNLOAD);
MP_DEFINE_STR_OBJ(mp_SYMBOL_DRIVE, SYMBOL_DRIVE);
MP_DEFINE_STR_OBJ(mp_SYMBOL_REFRESH, SYMBOL_REFRESH);
MP_DEFINE_STR_OBJ(mp_SYMBOL_MUTE, SYMBOL_MUTE);
MP_DEFINE_STR_OBJ(mp_SYMBOL_VOLUME_MID, SYMBOL_VOLUME_MID);
MP_DEFINE_STR_OBJ(mp_SYMBOL_VOLUME_MAX, SYMBOL_VOLUME_MAX);
MP_DEFINE_STR_OBJ(mp_SYMBOL_IMAGE, SYMBOL_IMAGE);
MP_DEFINE_STR_OBJ(mp_SYMBOL_EDIT, SYMBOL_EDIT);
MP_DEFINE_STR_OBJ(mp_SYMBOL_PREV, SYMBOL_PREV);
MP_DEFINE_STR_OBJ(mp_SYMBOL_PLAY, SYMBOL_PLAY);
MP_DEFINE_STR_OBJ(mp_SYMBOL_PAUSE, SYMBOL_PAUSE);
MP_DEFINE_STR_OBJ(mp_SYMBOL_STOP, SYMBOL_STOP);
MP_DEFINE_STR_OBJ(mp_SYMBOL_NEXT, SYMBOL_NEXT);
MP_DEFINE_STR_OBJ(mp_SYMBOL_EJECT, SYMBOL_EJECT);
MP_DEFINE_STR_OBJ(mp_SYMBOL_LEFT, SYMBOL_LEFT);
MP_DEFINE_STR_OBJ(mp_SYMBOL_RIGHT, SYMBOL_RIGHT);
MP_DEFINE_STR_OBJ(mp_SYMBOL_PLUS, SYMBOL_PLUS);
MP_DEFINE_STR_OBJ(mp_SYMBOL_MINUS, SYMBOL_MINUS);
MP_DEFINE_STR_OBJ(mp_SYMBOL_WARNING, SYMBOL_WARNING);
MP_DEFINE_STR_OBJ(mp_SYMBOL_SHUFFLE, SYMBOL_SHUFFLE);
MP_DEFINE_STR_OBJ(mp_SYMBOL_UP, SYMBOL_UP);
MP_DEFINE_STR_OBJ(mp_SYMBOL_DOWN, SYMBOL_DOWN);
MP_DEFINE_STR_OBJ(mp_SYMBOL_LOOP, SYMBOL_LOOP);
MP_DEFINE_STR_OBJ(mp_SYMBOL_DIRECTORY, SYMBOL_DIRECTORY);
MP_DEFINE_STR_OBJ(mp_SYMBOL_UPLOAD, SYMBOL_UPLOAD);
MP_DEFINE_STR_OBJ(mp_SYMBOL_CALL, SYMBOL_CALL);
MP_DEFINE_STR_OBJ(mp_SYMBOL_CUT, SYMBOL_CUT);
MP_DEFINE_STR_OBJ(mp_SYMBOL_COPY, SYMBOL_COPY);
MP_DEFINE_STR_OBJ(mp_SYMBOL_SAVE, SYMBOL_SAVE);
MP_DEFINE_STR_OBJ(mp_SYMBOL_CHARGE, SYMBOL_CHARGE);
MP_DEFINE_STR_OBJ(mp_SYMBOL_BELL, SYMBOL_BELL);
MP_DEFINE_STR_OBJ(mp_SYMBOL_KEYBOARD, SYMBOL_KEYBOARD);
MP_DEFINE_STR_OBJ(mp_SYMBOL_GPS, SYMBOL_GPS);
MP_DEFINE_STR_OBJ(mp_SYMBOL_FILE, SYMBOL_FILE);
MP_DEFINE_STR_OBJ(mp_SYMBOL_WIFI, SYMBOL_WIFI);
MP_DEFINE_STR_OBJ(mp_SYMBOL_BATTERY_FULL, SYMBOL_BATTERY_FULL);
MP_DEFINE_STR_OBJ(mp_SYMBOL_BATTERY_3, SYMBOL_BATTERY_3);
MP_DEFINE_STR_OBJ(mp_SYMBOL_BATTERY_2, SYMBOL_BATTERY_2);
MP_DEFINE_STR_OBJ(mp_SYMBOL_BATTERY_1, SYMBOL_BATTERY_1);
MP_DEFINE_STR_OBJ(mp_SYMBOL_BATTERY_EMPTY, SYMBOL_BATTERY_EMPTY);
MP_DEFINE_STR_OBJ(mp_SYMBOL_BLUETOOTH, SYMBOL_BLUETOOTH);
MP_DEFINE_STR_OBJ(mp_SYMBOL_DUMMY, SYMBOL_DUMMY);

STATIC const mp_rom_map_elem_t SYMBOL_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR_AUDIO), MP_ROM_PTR(&mp_SYMBOL_AUDIO) },
    { MP_ROM_QSTR(MP_QSTR_VIDEO), MP_ROM_PTR(&mp_SYMBOL_VIDEO) },
    { MP_ROM_QSTR(MP_QSTR_LIST), MP_ROM_PTR(&mp_SYMBOL_LIST) },
    { MP_ROM_QSTR(MP_QSTR_OK), MP_ROM_PTR(&mp_SYMBOL_OK) },
    { MP_ROM_QSTR(MP_QSTR_CLOSE), MP_ROM_PTR(&mp_SYMBOL_CLOSE) },
    { MP_ROM_QSTR(MP_QSTR_POWER), MP_ROM_PTR(&mp_SYMBOL_POWER) },
    { MP_ROM_QSTR(MP_QSTR_SETTINGS), MP_ROM_PTR(&mp_SYMBOL_SETTINGS) },
    { MP_ROM_QSTR(MP_QSTR_TRASH), MP_ROM_PTR(&mp_SYMBOL_TRASH) },
    { MP_ROM_QSTR(MP_QSTR_HOME), MP_ROM_PTR(&mp_SYMBOL_HOME) },
    { MP_ROM_QSTR(MP_QSTR_DOWNLOAD), MP_ROM_PTR(&mp_SYMBOL_DOWNLOAD) },
    { MP_ROM_QSTR(MP_QSTR_DRIVE), MP_ROM_PTR(&mp_SYMBOL_DRIVE) },
    { MP_ROM_QSTR(MP_QSTR_REFRESH), MP_ROM_PTR(&mp_SYMBOL_REFRESH) },
    { MP_ROM_QSTR(MP_QSTR_MUTE), MP_ROM_PTR(&mp_SYMBOL_MUTE) },
    { MP_ROM_QSTR(MP_QSTR_VOLUME_MID), MP_ROM_PTR(&mp_SYMBOL_VOLUME_MID) },
    { MP_ROM_QSTR(MP_QSTR_VOLUME_MAX), MP_ROM_PTR(&mp_SYMBOL_VOLUME_MAX) },
    { MP_ROM_QSTR(MP_QSTR_IMAGE), MP_ROM_PTR(&mp_SYMBOL_IMAGE) },
    { MP_ROM_QSTR(MP_QSTR_EDIT), MP_ROM_PTR(&mp_SYMBOL_EDIT) },
    { MP_ROM_QSTR(MP_QSTR_PREV), MP_ROM_PTR(&mp_SYMBOL_PREV) },
    { MP_ROM_QSTR(MP_QSTR_PLAY), MP_ROM_PTR(&mp_SYMBOL_PLAY) },
    { MP_ROM_QSTR(MP_QSTR_PAUSE), MP_ROM_PTR(&mp_SYMBOL_PAUSE) },
    { MP_ROM_QSTR(MP_QSTR_STOP), MP_ROM_PTR(&mp_SYMBOL_STOP) },
    { MP_ROM_QSTR(MP_QSTR_NEXT), MP_ROM_PTR(&mp_SYMBOL_NEXT) },
    { MP_ROM_QSTR(MP_QSTR_EJECT), MP_ROM_PTR(&mp_SYMBOL_EJECT) },
    { MP_ROM_QSTR(MP_QSTR_LEFT), MP_ROM_PTR(&mp_SYMBOL_LEFT) },
    { MP_ROM_QSTR(MP_QSTR_RIGHT), MP_ROM_PTR(&mp_SYMBOL_RIGHT) },
    { MP_ROM_QSTR(MP_QSTR_PLUS), MP_ROM_PTR(&mp_SYMBOL_PLUS) },
    { MP_ROM_QSTR(MP_QSTR_MINUS), MP_ROM_PTR(&mp_SYMBOL_MINUS) },
    { MP_ROM_QSTR(MP_QSTR_WARNING), MP_ROM_PTR(&mp_SYMBOL_WARNING) },
    { MP_ROM_QSTR(MP_QSTR_SHUFFLE), MP_ROM_PTR(&mp_SYMBOL_SHUFFLE) },
    { MP_ROM_QSTR(MP_QSTR_UP), MP_ROM_PTR(&mp_SYMBOL_UP) },
    { MP_ROM_QSTR(MP_QSTR_DOWN), MP_ROM_PTR(&mp_SYMBOL_DOWN) },
    { MP_ROM_QSTR(MP_QSTR_LOOP), MP_ROM_PTR(&mp_SYMBOL_LOOP) },
    { MP_ROM_QSTR(MP_QSTR_DIRECTORY), MP_ROM_PTR(&mp_SYMBOL_DIRECTORY) },
    { MP_ROM_QSTR(MP_QSTR_UPLOAD), MP_ROM_PTR(&mp_SYMBOL_UPLOAD) },
    { MP_ROM_QSTR(MP_QSTR_CALL), MP_ROM_PTR(&mp_SYMBOL_CALL) },
    { MP_ROM_QSTR(MP_QSTR_CUT), MP_ROM_PTR(&mp_SYMBOL_CUT) },
    { MP_ROM_QSTR(MP_QSTR_COPY), MP_ROM_PTR(&mp_SYMBOL_COPY) },
    { MP_ROM_QSTR(MP_QSTR_SAVE), MP_ROM_PTR(&mp_SYMBOL_SAVE) },
    { MP_ROM_QSTR(MP_QSTR_CHARGE), MP_ROM_PTR(&mp_SYMBOL_CHARGE) },
    { MP_ROM_QSTR(MP_QSTR_BELL), MP_ROM_PTR(&mp_SYMBOL_BELL) },
    { MP_ROM_QSTR(MP_QSTR_KEYBOARD), MP_ROM_PTR(&mp_SYMBOL_KEYBOARD) },
    { MP_ROM_QSTR(MP_QSTR_GPS), MP_ROM_PTR(&mp_SYMBOL_GPS) },
    { MP_ROM_QSTR(MP_QSTR_FILE), MP_ROM_PTR(&mp_SYMBOL_FILE) },
    { MP_ROM_QSTR(MP_QSTR_WIFI), MP_ROM_PTR(&mp_SYMBOL_WIFI) },
    { MP_ROM_QSTR(MP_QSTR_BATTERY_FULL), MP_ROM_PTR(&mp_SYMBOL_BATTERY_FULL) },
    { MP_ROM_QSTR(MP_QSTR_BATTERY_3), MP_ROM_PTR(&mp_SYMBOL_BATTERY_3) },
    { MP_ROM_QSTR(MP_QSTR_BATTERY_2), MP_ROM_PTR(&mp_SYMBOL_BATTERY_2) },
    { MP_ROM_QSTR(MP_QSTR_BATTERY_1), MP_ROM_PTR(&mp_SYMBOL_BATTERY_1) },
    { MP_ROM_QSTR(MP_QSTR_BATTERY_EMPTY), MP_ROM_PTR(&mp_SYMBOL_BATTERY_EMPTY) },
    { MP_ROM_QSTR(MP_QSTR_BLUETOOTH), MP_ROM_PTR(&mp_SYMBOL_BLUETOOTH) },
    { MP_ROM_QSTR(MP_QSTR_DUMMY), MP_ROM_PTR(&mp_SYMBOL_DUMMY) }
};

STATIC MP_DEFINE_CONST_DICT(SYMBOL_locals_dict, SYMBOL_locals_dict_table);

STATIC void SYMBOL_print(const mp_print_t *print,
    mp_obj_t self_in,
    mp_print_kind_t kind)
{
    mp_printf(print, "lvgl SYMBOL");
}



STATIC const mp_obj_type_t mp_SYMBOL_type = {
    { &mp_type_type },
    .name = MP_QSTR_SYMBOL,
    .print = SYMBOL_print,
    
    .locals_dict = (mp_obj_dict_t*)&SYMBOL_locals_dict,
};
...
STATIC mp_obj_t mp_lv_gauge_set_needle_count(size_t n_args, const mp_obj_t *args)
{
    ...
    const lv_color_t *colors = mp_write_ptr_lv_color32_t(args[2]);
...
STATIC mp_obj_t mp_lv_disp_flush(size_t n_args, const mp_obj_t *args)
{
    ...
    lv_color_t *color_p = mp_write_ptr_lv_color32_t(args[4]);
...
STATIC mp_obj_t mp_lv_disp_map(size_t n_args, const mp_obj_t *args)
{
    ...
    int32_t x2 = (int32_t)mp_obj_get_int(args[2]);
    int32_t y2 = (int32_t)mp_obj_get_int(args[3]);
    const lv_color_t *color_map = mp_write_ptr_lv_color32_t(args[4]);
...
{
    lv_color_t *dest = mp_write_ptr_lv_color32_t(args[0]);
    const lv_color_t *src = mp_write_ptr_lv_color32_t(args[1]);
    uint32_t length = (uint32_t)mp_obj_get_int(args[2]);
    lv_opa_t opa = (uint8_t)mp_obj_get_int(args[3]);
    lv_disp_mem_blend(dest, src, length, opa);
    return mp_const_none;
}

STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_disp_mem_blend_obj, 4, 4, mp_lv_disp_mem_blend);
...
{
    lv_color_t *dest = mp_write_ptr_lv_color32_t(args[0]);
    uint32_t length = (uint32_t)mp_obj_get_int(args[1]);
    lv_color_t color = mp_write_lv_color32_t(args[2]);
    lv_disp_mem_fill(dest, length, color);
    return mp_const_none;
}

STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_disp_mem_fill_obj, 3, 3, mp_lv_disp_mem_fill);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_disp_is_mem_blend_supported_obj, 0, 0, mp_lv_disp_is_mem_blend_supported);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_disp_is_mem_fill_supported_obj, 0, 0, mp_lv_disp_is_mem_fill_supported);
...
STATIC void mp_lv_vdb_t_attr(mp_obj_t self_in, qstr attr, mp_obj_t *dest)
{
    ...
    if (dest[0] == MP_OBJ_NULL) {
        ...
        switch(attr)
        {
            ...
            case MP_QSTR_buf: dest[0] = mp_read_ptr_lv_color32_t((void*)data->buf); break; // converting from lv_color_t*;
        ...
        if (dest[1])
        {
            ...
            switch(attr)
            {
                ...
                case MP_QSTR_buf: data->buf = (void*)mp_write_ptr_lv_color32_t(dest[1]); break; // converting to lv_color_t*;
                default: field_not_found(MP_QSTR_lv_vdb_t, attr);
            }
...
typedef typeof( ((lv_theme_t*)(0))->imgbtn ) lv_theme_imgbtn_t;
...
typedef typeof( ((lv_theme_t*)(0))->calendar ) lv_theme_calendar_t;
...
typedef typeof( ((lv_theme_t*)(0))->spinbox ) lv_theme_spinbox_t;
...
typedef typeof( ((lv_theme_t*)(0))->tileview ) lv_theme_tileview_t;
...
typedef typeof( ((lv_theme_t*)(0))->table ) lv_theme_table_t;
...
STATIC mp_obj_t mp_lv_fs_open(size_t n_args, const mp_obj_t *args)
{
    ...
    lv_fs_mode_t mode = (uint8_t)mp_obj_get_int(args[2]);
    lv_fs_res_t res = lv_fs_open(file_p, path, mode);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_fs_open_obj, 3, 3, mp_lv_fs_open);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_fs_close_obj, 1, 1, mp_lv_fs_close);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_fs_read_obj, 4, 4, mp_lv_fs_read);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_fs_write_obj, 4, 4, mp_lv_fs_write);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_fs_seek_obj, 2, 2, mp_lv_fs_seek);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_fs_tell_obj, 2, 2, mp_lv_fs_tell);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_fs_trunc_obj, 1, 1, mp_lv_fs_trunc);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_fs_size_obj, 2, 2, mp_lv_fs_size);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_fs_dir_open_obj, 2, 2, mp_lv_fs_dir_open);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_fs_dir_read_obj, 2, 2, mp_lv_fs_dir_read);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lv_fs_dir_close_obj, 1, 1, mp_lv_fs_dir_close);
...
STATIC const mp_rom_map_elem_t lvgl_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_SYMBOL), MP_ROM_PTR(&mp_SYMBOL_type) },
